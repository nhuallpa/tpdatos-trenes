...
#include "../../src/entidades/horario/hour.h"
#include "../../src/entidades/horario/date.h"
#include "../../src/utils/const.h"
#include "../../src/utils/utiles.h"
...
public:
	...
	void iniciar(){
		FranjaHoraria* franja_1 = new FranjaHoraria(12,0,13,0, 3,4,2012); //12:00-13:00-03/04/2012
				...
				cout<<"Primeros 3 del archivo franjas_horarias.org: "<<endl;
				this->listarFranjasHorarias_segun(3);
